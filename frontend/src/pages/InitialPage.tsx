        ...
        <>
            <Grid item xs={12} sx={{ marginTop: "10px" }}>
                <Typography variant="h5">
                    Faça o upload de{" "}
                    <Typography component="span" variant="h5" style={{ color: "dodgerblue" }} >
                        1 arquivo PDF
                    </Typography>{" "}
                    de uma prova antiga
                </Typography>
                ...
                <Typography variant="subtitle1" color="textSecondary" sx={{ marginTop: "5px" }} >
                    Certifique-se que há <strong>somente uma 1 questão por página</strong>.
                </Typography>
            </Grid>

            {/* Botões */}
            <Grid item container justifyContent="center" style={{ textAlign: "center" }} xs={12} sx={{ mt: 3 }} >
                {/* Botão de upload */}
                <UploadButton />
                {/* Botão de resolver */}
                <Grid item sx={{ mx: 1 }}>
